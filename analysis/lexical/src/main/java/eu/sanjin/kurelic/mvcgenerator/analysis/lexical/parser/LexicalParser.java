...
public class LexicalParser {
  ...
  private Token specialCharacterState() throws LexicalException {
    ...
    } else if (characterSupplier.isCharacter(SpecialCharacterToken.OR.toChar())) {
        if (characterSupplier.isNextCharacter(SpecialCharacterToken.OR.toChar())) {
            value = SpecialCharacterToken.CONCAT.toString(); // || (string concat)
        }
    }
      if (value == null) {
